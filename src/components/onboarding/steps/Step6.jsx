...
const Step6 = () => {
  return (
    <div>
      ...
      />
      <p className="mt-5">
        Vi håber, du nyder fordelene ved vores kundeklub og glæder os til at se dig stige i niveau!
      </p>
      <p className="mt-5 font-semibold">Som tak for dit medlemskab, har vi indsat 50 point på din konto!</p>
    </div>
  );
};
